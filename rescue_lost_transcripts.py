...
class TogaRescue:
    ...
    def __init__(self, args):
        ...
        # Old TOGA input
        # Required
        self.target_bed = args.target_bed if args.target_bed else os.path.join(self.togadir, "temp/toga_filt_ref_annot.bed")
        # Optional
        if args.isoforms:
        ...
        self.bed_filt_rejected = os.path.join(self.outdir, "target_annotation_rejected.txt")
